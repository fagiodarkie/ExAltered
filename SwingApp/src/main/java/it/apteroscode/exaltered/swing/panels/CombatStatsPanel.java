...
import it.apteroscode.exaltered.swing.saw.SolveAttackWizard;
...
public class CombatStatsPanel extends JPanel {
	...
	public CombatStatsPanel(MainPanel mainPanel, PlayCharacter c) {
		this.c = c;
		main = mainPanel;
		remodel();
	}
	...
	public void remodel() {
		...
		// Questo pannello � semplicemente di consultazione e dipende da altre variabili di c: salute, attributi ed equipaggiamento.
		...
		combatResolution.setBorder(BorderFactory.createTitledBorder("Utilit� di combattimento"));
		...
		// TODO da implementare la suite di movimenti che modificano DV e velocit�.
