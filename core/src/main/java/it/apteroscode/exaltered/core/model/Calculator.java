...
package it.apteroscode.exaltered.core.model;
...
//		// this is liftable
//		return getMaximal() * c.atts.attribute.get(Attributes.STAMINA) / 10;
//	}
//	public float getMaximal() {
//		int ability = (c.atts.attribute.get(Attributes.STRENGTH) + c.abils.getAbility(Abilities.RESISTANCE)), maximal = 0;
