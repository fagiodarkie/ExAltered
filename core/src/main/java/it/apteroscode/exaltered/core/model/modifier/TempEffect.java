...
package it.apteroscode.exaltered.core.model.modifier;
...
public class TempEffect {
	...
	public static final String[] poolsPenaltyName = {
		"Volont�", "Ess. Permanente", "Ess. Personale", "Ess. Periferica", "Valore",
	...
	public static final String[] battleStatsPenaltyName = {
		...
		"Equilibrio (Parata)", "Equilibrio (Schivata)", "Velocit�", "Danno Minimo" };
