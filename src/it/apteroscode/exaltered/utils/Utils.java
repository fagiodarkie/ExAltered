...
package it.apteroscode.exaltered.utils;
...
public class Utils {
	...
	public static String[] weaponStat = {
		"Peso", "Velocit�", "Bonus Precisione Fisico", "Bonus Parata Fisico",
		"Bonus Precisione Mentale", "Bonus Parata Mentale", "Perforanza", "Bonus Perforanza",
		"Commozione", "Cadenza", "Durabilit�", "Stazza"	};
	
	public static final String[] armorStat = {
		"Peso", "Impaccio", "Stazza", "Vestizione", "Durabilit�"};
