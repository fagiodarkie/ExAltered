...
public class Calculator {
	...
	public int getLoadMovementPenalty() {
		/* Le penalità (o bonus) al movimento si applica:
		1. Alle riserve di dadi in prove di agilità, destrezza e simili.
		2. Alla distanza che puoi percorrere in ogni tick, determinabile con la tua destrezza.
			Ad ogni modo puoi comunque muoverti di almeno 1 metro per tick, anche se la penalità dovesse
