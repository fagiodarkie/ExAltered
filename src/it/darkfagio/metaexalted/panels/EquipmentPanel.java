...
import it.darkfagio.metaexalted.model.Armor;
...
public class EquipmentPanel extends JPanel {
	...
	public EquipmentPanel(MainPanel mainPanel, it.darkfagio.metaexalted.model.PlayCharacter c) {
		this.c = c;
		main = mainPanel;
	...
	public void remodel() {
		...
		footLeft.add(new GUITextAttribute("Penalità di carico:", c.calc.getLoadMovementPenalty()));
		...
		footRight.add(new GUITextAttribute("Penalità minimi dell'arma:",
